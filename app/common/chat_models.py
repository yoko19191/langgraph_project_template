...
from langchain.chat_models.base import _attempt_infer_model_provider as langchain_infer_provider
...
def _init_chat_model_helper(
    ...
    **kwargs: Any,
    ...
    elif model_provider in ("zhipu", "glm"):
        from langchain_community.chat_models import ChatZhipuAI
        return ChatZhipuAI(
            model=model,
            **kwargs
        )
    elif model_provider in ("moonshot", "kimi"):
        from langchain_openai import ChatOpenAI
        return ChatOpenAI(
            model=model,
    ...
    elif model_provider in ("volcengine", "ark", "doubao"):
        from langchain_openai import ChatOpenAI
        return ChatOpenAI(
            model=model,
